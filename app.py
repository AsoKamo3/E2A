# app.py
# Eight → 宛名職人 変換（分割版） v1.5
# 役割：UIとHTTP入出力だけ。実処理は services.eight_to_atena へ委譲。

import io
from datetime import datetime
from flask import Flask, request, render_template_string, send_file, abort

from services.eight_to_atena import convert_text  # ← これだけ呼ぶ
...
def convert():
    ...
    try:
        out_csv_text = convert_text(csv_text)
